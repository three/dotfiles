...
# K is an alternative to ls for zsh shells
# https://github.com/supercrabtree/k 
# Commit e2bfbaf3b8ca92d6ffc4280211805ce4b8a8c19e
# Copyright (c) 2015 George Crabtree & Christopher Newton. MIT License.
k () {(
  # ----------------------------------------------------------------------------
  # Setup
  # ----------------------------------------------------------------------------
